...
export const STRATEGY_CONFIGS: Record<string, StrategyConfig> = {
  ...
  'blue-green': {
    ...
    description: 'Complete environment switch with manual approval',
    features: [
...
export const STAGE_DISPLAY_NAMES: Record<string, string> = {
  ...
  validate_green_environment: 'Validate Green Environment',
  await_traffic_switch: 'Awaiting Manual Approval',
  switch_traffic_to_green: 'Switch Traffic to Green',
  verify_green_traffic: 'Verify Green Traffic',
};
