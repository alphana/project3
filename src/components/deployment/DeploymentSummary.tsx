...
import { CheckCircle2, XCircle, AlertTriangle, FileText, RotateCcw, GitBranch, Clock, Zap } from 'lucide-react';
...
export function DeploymentSummary({
  ...
  return (
    <div className="space-y-6">
      ...
      {success && statistics.blueGreenInfo && (
        <div className="bg-gradient-to-r from-blue-50 to-green-50 border-2 border-green-200 rounded-lg p-4 space-y-3">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div className="bg-white rounded-lg p-3 border border-green-200">
                ...
                <span className="font-medium text-gray-900">
                  {statistics.blueGreenInfo.approvalTime}
                </span>
              </div>
              <div className="bg-white rounded-lg p-3 border border-green-200">
                <div className="flex items-center gap-2 text-gray-600 mb-1">
                  <Zap className="h-4 w-4" />
                  <span>Traffic Switch</span>
                </div>
                <span className="font-medium text-green-700">Instant</span>
              </div>
            </div>
            <div className="bg-white rounded-lg p-3 border border-blue-200">
              <p className="text-xs text-gray-600 mb-2">Environment Status:</p>
      ...
      {success && (
        <div className="bg-blue-50 rounded-lg p-4 space-y-2">
          ...
          <ul className="space-y-1 text-sm text-blue-700">
            ...
            {statistics.blueGreenInfo && (
              <li>• Blue environment available for instant rollback if needed</li>
            )}
          </ul>
        </div>
      )}
